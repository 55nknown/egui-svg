...
impl EguiSvg {
    ...
    pub fn ui(&mut self, ui: &mut egui::Ui) {
        let texture = self.texture.get_or_insert(self.load_texture(ui.ctx()));
        ui.image(texture, self.size);
    }
}
